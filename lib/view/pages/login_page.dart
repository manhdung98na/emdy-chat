        ...
        children: [
          Column(
            children: [
              ...
              Expanded(
                  child:
                      Image.asset(AssetsConfig.logo, height: 170, width: 170)),
              //input form
              Padding(
                padding:
          ...
          buildChangeThemeButton(context),
        ],
      ),
    );
  }
    ...
    return Row(
      ...
      children: [
        TextButton(
          ...
          child: const AppText(text: 'Vi'),
        ),
        TextButton(
          onPressed: () {
            localeProvider.setLocale(const Locale('en'));
          },
          child: const AppText(text: 'En'),
        ),
      ],
    );
  }

  Widget buildChangeThemeButton(BuildContext context) {
    return Positioned(
      right: 10,
      top: 10,
      child: IconButton(
